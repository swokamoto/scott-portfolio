...
**Structure First**  
Plan user flows, then build backend APIs and frontend components to support them cleanly.

**Real-Time Focus**  
Experience with WebSocket connections, state synchronization, and handling multiple users interacting with shared data.

**API Design**  
Clear backend API design with predictable data flow. Frontend state changes with immediate feedback.

**Error Handling**  
Build loading states, error boundaries, and reconnection logic for stable edge case handling.
...
Open to full-time and contract opportunities in full-stack development.